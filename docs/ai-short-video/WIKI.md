...
Wiki 首页（`Home`）默认应链到 **CURRENT + 最新 CHANGELOG + 最新 DIGEST**，让浏览入口直接落到摘要层：

- 当前版本 / 最新可读：`docs/ai-short-video/CURRENT.md`
- 最新版摘要：`docs/ai-short-video/v2026.09.13/CHANGELOG.md`
- 最新日摘要：`docs/ai-short-video/v0/inbox/2026-09-14/DIGEST.md`（上午+下午双扫 / 19 条）
...
- [最新日摘要 · 2026-09-14（上午+下午双扫 / 19 条）](../blob/master/docs/ai-short-video/v0/inbox/2026-09-14/DIGEST.md)
...
GitHub Wiki 的相对链接写法以仓库实际渲染为准；若 Wiki 尚未初始化或本环境写不了 Wiki，先保证本目录结构完整，再补 Wiki 首页。
